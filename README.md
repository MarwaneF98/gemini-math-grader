...
Whether you want to use the sleek web interface directly from your browser or run the Python script locally from your terminal, this tool acts like a virtual red pen. It analyzes a photo of a math paper, evaluates each step, and draws feedback exactly where it belongs—dodging the student's original handwriting and preventing annotation collisions.

---

## ✨ Features

* **Premium Modern UI:** A sleek, fully responsive dark-mode web application featuring a modern dropzone for file uploads and native mobile support.
